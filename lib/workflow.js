...
// Called by the admin "Generate" button AND by n8n (via /api/admin/generate-one).
async function generateOneInternal(extraInstructions) {
  ...
  appendGenLog({ stage: 'generation_started', extraInstructions: extraInstructions || null });
